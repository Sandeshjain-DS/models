...
PATH_TO_LABELS = os.path.join('data', 'object-detection.pbtxt')  # our labels are in training/object-detection.pbkt
...
TEST_IMAGE_PATHS = [os.path.join(PATH_TO_TEST_IMAGES_DIR, 'image{}.jpeg'.format(i)) for i in range(1, 23)]  # adjust range for # of images in folder
...
with detection_graph.as_default():
    with tf.Session(graph=detection_graph) as sess:
        ...
        for image_path in TEST_IMAGE_PATHS:
            ...
            plt.savefig("outputs/detection_output{}.jpeg".format(i))  # create an outputs folder for the images to be saved
